        ...
        begin
            ...
            begin
                ...
                begin
                  ...
                  vltotalStr := fieldbyname('vl_total').AsString;

                // Log do valor original para depuração
                //ShowMessage('Valor original do preço: ' + vltotal);

                // Verifique o formato e ajuste se necessário
                  if Pos('.', vltotalStr) > 0 then
                  vltotalStr := StringReplace(vltotalStr, '.', ',', [rfReplaceAll]);

                  // Tenta converter as strings para Double
                try
                    vltotal := StrToFloat(vltotalStr, FormatSettings);
                except
                    on E: EConvertError do
                    begin
                        ShowMessage('Erro ao converter o valor total: ' + E.Message + ' - Valor: ' + vltotalStr);
                        Exit;
                    end;
                end;
