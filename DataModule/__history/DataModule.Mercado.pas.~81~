...
uses
  ...
  RESTRequest4D, DataSet.Serialize.Adapter.RESTRequest4D, DataSet.Serialize.Config, uConsts,
  FireDAC.Stan.Async, FireDAC.DApt, Math, System.JSON;
...
begin
    resp := TRequest.New.BaseURL(BASE_URL)
            .Resource('mercados')
            .Adapters(TDataSetSerializeAdapter.New(TabMercado))
