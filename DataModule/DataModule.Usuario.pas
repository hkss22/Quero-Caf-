...
uses
  ...
  DataSet.Serialize.Config, RESTRequest4D, System.JSON, DataSet.Serialize.Adapter.RESTRequest4D, uConsts,
...
type
  ...
  public
    ...
    procedure CriarConta(nome, email, senha, endereco, bairro, cidade, uf,
                          cep: string);
    procedure SalvarUsarioLocal(id_usuario: integer;
...
procedure TDmUsuario.SalvarUsarioLocal(id_usuario: integer;
                                        email, nome, endereco, bairro,
                                        cidade, uf, cep: string);
begin
    with QryUsuario do
