...
begin
  ...
  CleanStr := StringReplace(CleanStr, ',', '', [rfReplaceAll]); // Remove a vírgula, se necessário
...
begin
  // Cria as configurações de formato
    ...
    // Atualiza a exibição da quantidade e do valor
...
begin
    ...
    begin
        ...
        begin
            ...
            begin
                lblEndereco.Text := jsonObj.GetValue<string>('endereco', ''); // Exibe o endereço
                lblMercadoEnd.Visible := True; // Mostra o endereço do mercado
            end;
