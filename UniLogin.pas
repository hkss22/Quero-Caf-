...
uses
  ...
  FMX.Objects, FMX.Layouts, FMX.Edit, FMX.Controls.Presentation, FMX.StdCtrls,
  uLoading, uSession;
...
begin
    ...
    begin
        ...
        begin
            ...
            begin
                DmUsuario.SalvarUsarioLocal(fieldbyname('id_usuario').asinteger,
                                            edtEmailCad.text,
                                            edtNomeCad.text,
                                            edtEnderecoCad.text,
                                            edtBairroCad.text,
