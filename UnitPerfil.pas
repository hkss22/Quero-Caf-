       ...
       // sleep(1000);
        ...
        begin
            ...
            begin
                ...
                edtSenha.Text := fieldbyname('senha').asstring; //OBS: Não é uma boa prática retornar senha do úsuario.
...
begin
    ...
    begin
       ...
       //Salvar dados do usuario localmente...
        DmUsuario.SalvarUsarioLocal(TSession.ID_USUARIO, edtEmail.Text, edtNome.Text,
                                   edtEndereco.Text, edtBairro.Text, edtCidade.Text, edtUF.Text, edtCEP.Text);
